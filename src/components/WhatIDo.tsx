        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>MARKETING</h3>
              <h4>Digital Strategy & E-commerce</h4>
              <p>
                Managing full-stack digital strategies, ROI-focused campaigns, SEO/GEO/AEO, and e-commerce operations for the global market.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Creating AI-powered motion graphics, commercial videos, and sound design via cutting-edge AI automation tools for modern brands.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">ChatGPT / Claude</div>
                <div className="what-tags">MidJourney</div>
                <div className="what-tags">Premiere Pro</div>
                <div className="what-tags">After Effects</div>
                <div className="what-tags">Runway / Sora</div>
                <div className="what-tags">Make.com</div>
                <div className="what-tags">ElevenLabs / Suno</div>
